# Generated by Django 3.2.16 on 2024-07-25 03:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text=('Индефикатор страницы для URL; разрешины символы', 'латиницы, цифры, дефис и подчеркивание.'), unique=True, verbose_name='Индефикатор')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='blog.category', verbose_name='Категория')),
